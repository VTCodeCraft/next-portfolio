...
export default function Home() {
  return (
    <div className="flex w-full max-w-6xl flex-col gap-8 lg:grid lg:grid-cols-[20%_20%_60%] lg:gap-0">
      {/* LEFT SIDEBAR */}
      <aside className="w-full lg:sticky lg:top-32 lg:flex lg:min-h-[calc(100vh-16rem)] lg:items-center lg:self-start">
        <Sidebar />
      </aside>
