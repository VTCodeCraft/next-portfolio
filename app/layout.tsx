...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body
        className={`${manrope.className} ${manrope.variable} ${sora.variable} relative min-h-screen overflow-x-hidden bg-[#f4fbfc] text-gray-900 transition-colors duration-300 dark:bg-[#05060f] dark:text-white`}
        suppressHydrationWarning
      >
