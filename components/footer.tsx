...
export default function Footer() {
  return (
    <footer className="pb-8 px-4 text-center">
      <div className="mx-auto max-w-lg border-t border-gray-200 pt-5">
        <small className="mb-3 block text-xs font-medium tracking-widest text-gray-400 uppercase">
        ...
        <Link
          ...
          className="mt-4 inline-flex items-center gap-2 text-[11px] text-gray-400 transition hover:text-gray-600"
        >
